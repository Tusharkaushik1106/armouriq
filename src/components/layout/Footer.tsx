...
export function Footer() {
  ...
  return (
    ...
    >
      {/* Giant brand marquee at top of footer */}
      <div className="relative py-8 md:py-10 border-b border-[var(--color-border)]">
        <Marquee speed={30}>
          <span
      ...
      <div className="pt-20 pb-10">
        <Container>
          ...
          <div className="footer-col mt-6 font-mono text-[10px] uppercase tracking-[0.15em] text-[var(--color-text-light)] text-center md:text-left" style={{ opacity: 0.6 }}>
